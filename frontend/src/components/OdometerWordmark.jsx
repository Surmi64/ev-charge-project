...
import { HUES } from '../utils/palette';
...
const OdometerWordmark = ({ segments = DEFAULT_SEGMENTS, scale = 1 }) => {
  ...
  // dark:  #f2f6f8 on #2b333a is 10.9:1, accent on #2b333a is 5.1:1.
  // light: #14181c on #fbfcfd is 16.4:1, accent on #fbfcfd is 5.5:1.
  // The accent is the brand red, not a wordmark-only one, which is what keeps it in
  // step with the destructive items in the sidebar.
  ...
  const accentColor = isDark ? HUES.dark.red : HUES.light.red;
